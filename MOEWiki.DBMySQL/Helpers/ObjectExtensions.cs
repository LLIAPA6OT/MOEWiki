...
namespace MOEWiki.DBMySQL.Helpers
{
    public static class ObjectExtensions
    {
        ...
        public static void SetValueByPropertyName(this object obj, string propName, object value)
        {
            ...
            else if (prop.PropertyType == typeof(bool) || prop.PropertyType == typeof(bool?))
            {
                ...
                else if (value.GetType() == typeof(short) || value.GetType() == typeof(short?))
                ...
                else if (value.GetType() == typeof(long) || value.GetType() == typeof(long?))
